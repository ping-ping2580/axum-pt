...
import { FunctionPluginHooks, RollupError, RolldownOptions, OutputOptions, SourceMap, ModuleInfo, PartialResolvedId, InputOption, ModuleFormat, WatcherOptions, RolldownOutput, RolldownWatcher, PluginContext, InputOptions, CustomPluginOptions, LoadResult, SourceDescription, PluginContextMeta, RollupLog, ImportKind, ModuleType, OutputBundle, OutputChunk, ObjectHook, ResolveIdResult, TransformPluginContext, ModuleTypeFilter, ExistingRawSourceMap, SourceMapInput } from 'rolldown';
import * as rolldown from 'rolldown';
export { rolldown as Rolldown };
export { VERSION as rolldownVersion } from 'rolldown';
import * as rollupTypeCompat_js from '../../types/internal/rollupTypeCompat.js';
export { rollupTypeCompat_js as Rollup };
...
import { FetchFunctionOptions, FetchResult, ModuleRunnerOptions, ModuleRunnerHmr, ModuleEvaluator, ModuleRunner } from 'rolldown-vite/module-runner';
export { FetchFunction, FetchResult } from 'rolldown-vite/module-runner';
import { DepsOptimizerEsbuildOptions, EsbuildTarget, EsbuildTransformOptions, EsbuildTransformResult } from '../../types/internal/esbuildOptions.js';
export { EsbuildTransformOptions } from '../../types/internal/esbuildOptions.js';
...
declare class MinimalPluginContext implements rolldown.MinimalPluginContext {
...
declare function transformWithEsbuild(code: string, filename: string, options?: EsbuildTransformOptions, inMap?: object, config?: ResolvedConfig, watcher?: FSWatcher, 
 ...
 * @deprecated use build.rollupOptions.output.manualChunks or framework specific configuration
 */
declare function splitVendorChunk(_options?: {
