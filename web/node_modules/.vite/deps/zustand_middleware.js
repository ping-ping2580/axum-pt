//#region node_modules/.pnpm/zustand@5.0.5_@types+react@19.1.6_immer@9.0.21_react@19.1.0_use-sync-external-store@1.5.0_react@19.1.0_/node_modules/zustand/esm/middleware.mjs
...
const devtoolsImpl = (fn, devtoolsOptions = {}) => (set, get, api) => {
	...
	if (connectionInformation.type === "untracked") connection?.init(initialState);
		...
		connection == null || connection.init(Object.fromEntries(Object.entries(connectionInformation.stores).map(([key, store2]) => [key, key === connectionInformation.store ? initialState : store2.getState()])));
	}
