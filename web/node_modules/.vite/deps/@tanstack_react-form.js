...
import { Derived, Store, batch, useStore } from "./esm-CX0XDIUz.js";
import "./with-selector-DtYlzctE.js";

//#region node_modules/.pnpm/@tanstack+form-core@1.12.0/node_modules/@tanstack/form-core/dist/esm/utils.js
...
function makePathArray(str) {
	...
	return str.replace(/(^\[)|]/gm, "").replace(/\[/g, ".").replace(reLineOfOnlyDigits, intReplace).replace(reDigitsBetweenDots, `.${intReplace}.`).replace(reStartWithDigitThenDot, `${intReplace}.`).replace(reDotWithDigitsToEnd, `.${intReplace}`).replace(reMultipleDots, ".").split(".").map((d) => {
		if (d.indexOf(intPrefix) === 0) return parseInt(d.substring(intPrefix.length), 10);
		return d;
	});
}
...
function getAsyncValidatorArray(cause, options) {
	...
	switch (cause) {
		...
		case "blur": return [blurValidator];
		case "change": return [changeValidator];
		case "server":
		default: return [];
	}
}
function getSyncValidatorArray(cause, options) {
	...
	switch (cause) {
		case "mount": return [mountValidator];
		case "submit": return [
			changeValidator,
			blurValidator,
			submitValidator,
		...
		case "server": return [serverValidator];
		case "blur": return [blurValidator, serverValidator];
		case "change":
		default: return [changeValidator, serverValidator];
	}
}
...
//#endregion
//#region node_modules/.pnpm/@tanstack+form-core@1.12.0/node_modules/@tanstack/form-core/dist/esm/standardSchemaValidator.js
...
//#endregion
//#region node_modules/.pnpm/@tanstack+form-core@1.12.0/node_modules/@tanstack/form-core/dist/esm/metaHelper.js
...
function metaHelper(formApi) {
	...
	function getAffectedFields(field, index, mode, secondIndex) {
		...
		if (mode === "swap") affectedFieldKeys.push(getFieldPath(field, secondIndex));
		else if (mode === "move") {
	...
	const handleMoveMode = (fields, field, fromIndex, toIndex) => {
		const fromFields = new Map(Object.keys(formApi.fieldInfo).filter((fieldKey) => fieldKey.startsWith(getFieldPath(field, fromIndex))).map((fieldKey) => [fieldKey, formApi.getFieldMeta(fieldKey)]));
...
//#endregion
//#region node_modules/.pnpm/@tanstack+form-core@1.12.0/node_modules/@tanstack/form-core/dist/esm/FormApi.js
	...
	*/
	constructor(opts) {
		...
		this.mount = () => {
			...
			(_b = (_a2 = this.options.listeners) == null ? void 0 : _a2.onMount) == null || _b.call(_a2, { formApi: this });
		...
		this.update = (options) => {
			...
			batch(() => {
				this.baseStore.setState(() => getDefaultFormState(Object.assign({}, this.state, shouldUpdateState ? options.defaultState : {}, shouldUpdateValues ? { values: options.defaultValues } : {}, shouldUpdateReeval ? { _force_re_eval: !this.state._force_re_eval } : {})));
			});
		};
		this.reset = (values, opts2) => {
			const { fieldMeta: currentFieldMeta } = this.state;
			const fieldMetaBase = this.resetFieldMeta(currentFieldMeta);
			if (values && !(opts2 == null ? void 0 : opts2.keepDefaultValues)) this.options = {
				...this.options,
		...
		this.validateSync = (cause) => {
			...
			batch(() => {
				...
				for (const validateObj of validates) {
					...
					for (const field of Object.keys(this.state.fieldMeta)) {
						...
						const { newErrorValue, newSource } = determineFormLevelErrorSourceAndValue({
							...
							isPreviousErrorFromFormValidator: (currentErrorMapSource == null ? void 0 : currentErrorMapSource[errorMapKey]) === "form",
						...
						if ((currentErrorMap == null ? void 0 : currentErrorMap[errorMapKey]) !== newErrorValue) this.setFieldMeta(field, (prev) => ({
							...prev,
							errorMap: {
								...prev.errorMap,
					...
					if (((_a2 = this.state.errorMap) == null ? void 0 : _a2[errorMapKey]) !== formError) this.baseStore.setState((prev) => ({
						...prev,
						errorMap: {
							...prev.errorMap,
				...
				if (((_b = this.state.errorMap) == null ? void 0 : _b[submitErrKey]) && cause !== "submit" && !hasErrored) this.baseStore.setState((prev) => ({
					...prev,
					errorMap: {
						...prev.errorMap,
						[submitErrKey]: void 0
		...
		this.validateAsync = async (cause) => {
			...
			for (const validateObj of validates) {
				...
				fieldValidatorMeta == null || fieldValidatorMeta.lastAbortController.abort();
			...
			if (promises.length) {
				...
				for (const fieldValidationResult of results) if (fieldValidationResult == null ? void 0 : fieldValidationResult.fieldErrors) {
		...
		this.pushFieldValue = (field, value, opts2) => {
			this.setFieldValue(field, (prev) => [...Array.isArray(prev) ? prev : [], value], opts2);
			...
			fn: ({ prevDepVals, currDepVals, prevVal: _prevVal }) => {
				...
				for (const fieldName of Object.keys(currBaseStore.fieldMetaBase)) {
					...
					if (!prevBaseMeta || currBaseMeta.errorMap !== prevBaseMeta.errorMap) {
						...
						if (fieldInstance && !fieldInstance.options.disableErrorFlat) fieldErrors = fieldErrors == null ? void 0 : fieldErrors.flat(1);
					}
					const isFieldValid = !isNonEmptyArray(fieldErrors ?? []);
					const isFieldPristine = !currBaseMeta.isDirty;
					const isDefaultValue = evaluate(curFieldVal, getBy(this.options.defaultValues, fieldName)) || evaluate(curFieldVal, (_c = (_b = this.getFieldInfo(fieldName)) == null ? void 0 : _b.instance) == null ? void 0 : _c.options.defaultValue);
		...
		this.store = new Derived({
			...
			fn: ({ prevDepVals, currDepVals, prevVal: _prevVal }) => {
				...
				const shouldInvalidateOnMount = isTouched && ((_a2 = currBaseStore.errorMap) == null ? void 0 : _a2.onMount);
				const isDirty = fieldMetaValues.some((field) => field.isDirty);
				const isPristine = !isDirty;
				const hasOnMountError = Boolean(((_b = currBaseStore.errorMap) == null ? void 0 : _b.onMount) || fieldMetaValues.some((f) => {
					var _a3;
					return (_a3 = f == null ? void 0 : f.errorMap) == null ? void 0 : _a3.onMount;
				}));
				const isValidating = !!isFieldsValidating;
				let errors = (prevVal == null ? void 0 : prevVal.errors) ?? [];
				if (!prevBaseStore || currBaseStore.errorMap !== prevBaseStore.errorMap) errors = Object.values(currBaseStore.errorMap).reduce((prev, curr) => {
				...
				if (shouldTransform) {
					...
					(_d = this.options.transform) == null || _d.fn(newObj);
					state = newObj.state;
	...
	*/
	...
	async handleSubmit(submitMeta) {
		...
		if (!this.state.isFieldsValid) {
			...
			(_b = (_a = this.options).onSubmitInvalid) == null || _b.call(_a, {
				value: this.state.values,
				formApi: this
			});
			return;
		...
		if (!this.state.isValid) {
			...
			(_d = (_c = this.options).onSubmitInvalid) == null || _d.call(_c, {
				value: this.state.values,
				formApi: this
			});
			return;
		...
		batch(() => {
			Object.values(this.fieldInfo).forEach((field) => {
				var _a2, _b2, _c2;
				(_c2 = (_b2 = (_a2 = field.instance) == null ? void 0 : _a2.options.listeners) == null ? void 0 : _b2.onSubmit) == null || _c2.call(_b2, {
					value: field.instance.state.value,
					fieldApi: field.instance
				});
			});
		});
		(_f = (_e = this.options.listeners) == null ? void 0 : _e.onSubmit) == null || _f.call(_e, { formApi: this });
		try {
...
//#endregion
//#region node_modules/.pnpm/@tanstack+form-core@1.12.0/node_modules/@tanstack/form-core/dist/esm/FieldApi.js
var FieldApi = class {
	/**
	...
	*/
	constructor(opts) {
		...
		this.mount = () => {
			...
			if (this.options.defaultValue !== void 0) this.form.setFieldValue(this.name, this.options.defaultValue, { dontUpdateMeta: true });
			...
			(_b = (_a = this.options.listeners) == null ? void 0 : _a.onMount) == null || _b.call(_a, {
				value: this.state.value,
				fieldApi: this
			});
			return cleanup;
		...
		this.update = (opts2) => {
			...
			if (this.state.value === void 0) {
				...
				if (nameHasChanged) this.setValue((val) => val || defaultValue, { dontUpdateMeta: true });
				else if (defaultValue !== void 0) this.setValue(defaultValue, { dontUpdateMeta: true });
			}
			if (this.form.getFieldMeta(this.name) === void 0) this.setMeta(this.state.meta);
		};
		this.getValue = () => {
		...
		this.getLinkedFields = (cause) => {
			...
			for (const field of fields) {
				...
				if (cause === "change" && (onChangeListenTo == null ? void 0 : onChangeListenTo.includes(this.name))) linkedFields.push(field.instance);
				if (cause === "blur" && (onBlurListenTo == null ? void 0 : onBlurListenTo.includes(this.name))) linkedFields.push(field.instance);
			}
			return linkedFields;
		};
		this.validateSync = (cause, errorFromForm) => {
			...
			batch(() => {
				const validateFieldFn = (field, validateObj) => {
					...
					if (((_a2 = field.state.meta.errorMap) == null ? void 0 : _a2[errorMapKey]) !== newErrorValue) field.setMeta((prev) => ({
						...prev,
						errorMap: {
							...prev.errorMap,
							[errorMapKey]: newErrorValue
			...
			if (((_a = this.state.meta.errorMap) == null ? void 0 : _a[submitErrKey]) && cause !== "submit" && !hasErrored) this.setMeta((prev) => ({
				...prev,
				errorMap: {
					...prev.errorMap,
					[submitErrKey]: void 0
		...
		this.validate = (cause, opts2) => {
			...
			if (hasErrored && !this.options.asyncAlways) {
				(_a = this.getInfo().validationMetaMap[getErrorMapKey(cause)]) == null || _a.lastAbortController.abort();
	...
	*/
	...
	triggerOnBlurListener() {
		...
		if (formDebounceMs && formDebounceMs > 0) {
			...
			this.timeoutIds.formListeners.blur = setTimeout(() => {
				var _a2, _b2;
				(_b2 = (_a2 = this.form.options.listeners) == null ? void 0 : _a2.onBlur) == null || _b2.call(_a2, {
					formApi: this.form,
					fieldApi: this
				});
			}, formDebounceMs);
		} else (_c = (_b = this.form.options.listeners) == null ? void 0 : _b.onBlur) == null || _c.call(_b, {
			formApi: this.form,
			fieldApi: this
		});
		...
		if (fieldDebounceMs && fieldDebounceMs > 0) {
			...
			this.timeoutIds.listeners.blur = setTimeout(() => {
				var _a2, _b2;
				(_b2 = (_a2 = this.options.listeners) == null ? void 0 : _a2.onBlur) == null || _b2.call(_a2, {
					value: this.state.value,
					fieldApi: this
				});
			}, fieldDebounceMs);
		} else (_f = (_e = this.options.listeners) == null ? void 0 : _e.onBlur) == null || _f.call(_e, {
			value: this.state.value,
			fieldApi: this
		});
	}
	triggerOnChangeListener() {
		...
		if (formDebounceMs && formDebounceMs > 0) {
			...
			this.timeoutIds.formListeners.blur = setTimeout(() => {
				var _a2, _b2;
				(_b2 = (_a2 = this.form.options.listeners) == null ? void 0 : _a2.onChange) == null || _b2.call(_a2, {
					formApi: this.form,
					fieldApi: this
				});
			}, formDebounceMs);
		} else (_c = (_b = this.form.options.listeners) == null ? void 0 : _b.onChange) == null || _c.call(_b, {
			formApi: this.form,
			fieldApi: this
		});
		...
		if (fieldDebounceMs && fieldDebounceMs > 0) {
			...
			this.timeoutIds.listeners.change = setTimeout(() => {
				var _a2, _b2;
				(_b2 = (_a2 = this.options.listeners) == null ? void 0 : _a2.onChange) == null || _b2.call(_a2, {
					value: this.state.value,
					fieldApi: this
				});
			}, fieldDebounceMs);
		} else (_f = (_e = this.options.listeners) == null ? void 0 : _e.onChange) == null || _f.call(_e, {
			value: this.state.value,
			fieldApi: this
		});
	}
...
//#endregion
//#region node_modules/.pnpm/@tanstack+form-core@1.12.0/node_modules/@tanstack/form-core/dist/esm/mergeForm.js
...
//#endregion
//#region node_modules/.pnpm/@tanstack+form-core@1.12.0/node_modules/@tanstack/form-core/dist/esm/formOptions.js
function formOptions(defaultOpts) {
	return defaultOpts;
}

//#endregion
//#region node_modules/.pnpm/@tanstack+react-form@1.12.0_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/@tanstack/react-form/dist/esm/useIsomorphicLayoutEffect.js
var import_react = __toESM(require_react(), 1);
const useIsomorphicLayoutEffect = typeof window !== "undefined" ? import_react.useLayoutEffect : import_react.useEffect;

//#endregion
//#region node_modules/.pnpm/@tanstack+react-form@1.12.0_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/@tanstack/react-form/dist/esm/useField.js
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-form@1.12.0_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/@tanstack/react-form/dist/esm/useForm.js
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-form@1.12.0_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/@tanstack/react-form/dist/esm/useTransform.js
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-form@1.12.0_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/@tanstack/react-form/dist/esm/createFormHook.js
...
function createFormHook({ fieldComponents, fieldContext, formContext, formComponents }) {
	function useAppForm(props) {
		...
		const AppField = (0, import_react.useMemo)(() => {
			return ({ children,...props2 }) => {
				return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(form.Field, {
					...props2,
					children: (field) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(fieldContext.Provider, {
						value: field,
		...
		const extendedForm = (0, import_react.useMemo)(() => {
...
//#endregion
export { Field, FieldApi, FormApi, createFormHook, createFormHookContexts, deleteBy, determineFieldLevelErrorSourceAndValue, determineFormLevelErrorSourceAndValue, evaluate, formOptions, functionalUpdate, getAsyncValidatorArray, getBy, getSyncValidatorArray, isGlobalFormValidationError, isNonEmptyArray, isStandardSchemaValidator, makePathArray, mergeForm, mutateMergeDeep, setBy, standardSchemaValidators, useField, useForm, useStore, useTransform };
